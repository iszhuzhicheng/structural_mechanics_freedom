      ...
      return {
        ...
        dj: function(model) {
          ...
          _.each(model.get("connects"), function(num) {
            if (drawC.models[num].get("category") == "bar" &&
              model.get("type") !== "gdd" &&
              model.get("type") !== "dxj") {
              blackArc(x, y);
            }
        ...
        linebar: function(model) {
          ...
          _.each(model.get("connects"), function(num) {
            var x = drawC.models[num].get("x")
              , y = drawC.models[num].get("y")

            if (drawC.models[num].get("category") == "constr" &&
              drawC.models[num].get("type") !== "gdd" &&
              drawC.models[num].get("type") !== "dxj") {
              blackArc(x, y)
            }
          })

App.Collections.calculate = Backbone.Collection.extend({
  ...
  initialize: function() {
    this.listenTo(App.drawC, "add", this.captain)
      ...
      _.each(model.connects, function(connectorder) {
        ...
        _.each(this.models, function(calculative) {
          ...
          _.each(calculative.c, function(c) {
            ...
            if (App.canvV.tools.b2bhead(x1, y1, null, null, cx1, cy1, cx2, cy2, 0)) {
              coorx = x1
              coory = y1
            } else if (App.canvV.tools.b2bhead(x2, y2, null, null, cx1, cy1, cx2, cy2, 0)) {
              coorx = x2
              coory = y2
            }
